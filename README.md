# z_image_turbo_inpaint.json

Dockerized ComfyUI workflow: Z_Image_Turbo_Inpaint.json
...
docker build -t z_image_turbo_inpaint.json .

# Run the container
docker run -p 8188:8188 z_image_turbo_inpaint.json
```
